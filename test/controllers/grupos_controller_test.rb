...
class GruposControllerTest < ActionController::TestCase
  ...
  test "should create grupo" do
    assert_difference('Grupo.count') do
      post :create, grupo: { codgrupo: @grupo.codgrupo, codseccion: @grupo.codseccion, codsubgrupo: @grupo.codsubgrupo, descripcion: @grupo.descripcion }
    end
  ...
  test "should update grupo" do
    patch :update, id: @grupo, grupo: { codgrupo: @grupo.codgrupo, codseccion: @grupo.codseccion, codsubgrupo: @grupo.codsubgrupo, descripcion: @grupo.descripcion }
    assert_redirected_to grupo_path(assigns(:grupo))
  end
